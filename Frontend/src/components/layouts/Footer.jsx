    ...
    <div className="bg-[#FFF5E0]">
      <div className="bg-slate-900 px-8 py-4 pb-8 rounded-t-[50px] text-center">
        ...
        <div className="pt-2 flex md:gap-3 justify-center font-medium text-white">
          <Link className="px-2 hover:text-green-400" to="/about">
            About
          </Link>
          |
          <Link className="px-2 hover:text-green-400" to="/contact">
            Contact
          </Link>
          |
          <Link className="px-2 hover:text-green-400" to="/privacypolicy">
            Privacy Policy
          </Link>
        </div>
      </div>
